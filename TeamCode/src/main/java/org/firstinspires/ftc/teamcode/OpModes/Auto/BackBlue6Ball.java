...
@Autonomous (preselectTeleOp = "TeleOpBlue", group = "Back6Ball")
public class BackBlue6Ball extends AutoBase {
...
//        grab2.setConstantHeadingInterpolation(grab2Pose.getHeading());
