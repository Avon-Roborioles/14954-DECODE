...
public class FrontSetpointNoTurn extends CommandBase {
    private LaunchSubsystem launchSubsystem;
    private LightSubsystem lightSubsystem;
    private boolean redAlliance;


    public FrontSetpointNoTurn(LaunchSubsystem launchSubsystem,LightSubsystem lightSubsystem,boolean redAlliance){
