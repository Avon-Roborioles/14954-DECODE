...
@Autonomous (preselectTeleOp = "TeleOpRed", group = "Back6Ball")
public class BackRed6Ball extends AutoBase{
    ...
    Pose launch1Pose = new Pose(62, 15, Math.toRadians(-3));
    Pose prepGrab2Pose = new Pose(45, 60, Math.toRadians(0));
