...
@Autonomous(name = "3 Artifacts Back Blue", group = "3 Artifacts", preselectTeleOp = "TeleOpBlue")
public class BackBlue3Only extends AutoBase{
    ...
    Pose leavePose = new Pose(75, 7, Math.toRadians(0));
